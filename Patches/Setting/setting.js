...
const SECTIONS = [
    ...
    },
    {
        name: 'Cursor', priority: 2, settings: [
            ...
            { type: Ui.ComponentType.Toggle, id: 'XSOverlayTweak.HandleScrolling', name: 'Handle Scrolling', description: 'Support horizontal scrolling.', default: true },
    ...
    },
    {
        name: 'Pointer', priority: 3, settings: [
            ...
            { type: Ui.ComponentType.Dropdown, id: 'XSOverlayTweak.PullTriggerPointerLock', name: 'Pull Trigger Pointer Lock/Smooth', description: 'Locks/Smooths the Pointer while the Trigger is held for easier double clicking.<br><br><b>- Uses the Trigger Value from SteamVR Input and Double Click Delay from XSOverlay settings.</b>', default: "Smooth for Capture Overlay", options: ['Disable', 'Lock for Capture Overlay', 'Lock for Capture + WebView Overlay', 'Smooth for Capture Overlay', 'Smooth for Capture + WebView Overlay'] },
            { type: Ui.ComponentType.Toggle, id: 'XSOverlayTweak.TwoHandedMode', name: 'Two Handed Mode', description: 'Allow both hands to become active hands at the same time to perform a Click simultaneously for two-hand interaction.', default: false },
        ]
    },
    {
    ...
    },
    {
        name: 'Mouse ', priority: 6, settings: [
            ...
            { type: Ui.ComponentType.Dropdown, id: 'XSOverlayTweak.MouseNavigation', name: 'Mouse Navigation', description: 'Custom keybindings for Mouse Forward/Back navigation.<br><br><b>- Press \'Bindings\' tab in XSOverlay settings to open<br>&nbsp;&nbsp;&nbsp;SteamVR bindings menu.<br>&nbsp;&nbsp;&nbsp;Edit the Current Binding, add and assign the button click mode<br>&nbsp;&nbsp;&nbsp;for \'MouseBack\' and \'Forward\'.<br>- Mouse 4/Mouse: target at the hovering window.<br>- Alt + Left/Right: target at the focused window.</b>', default: "Disabled", options: ["Disabled", "Enable (Mouse 4/Mouse 5)", "Enable (Alt + Left/Right)"] },
    ...
    },
    {
        name: 'Haptic Feedback', priority: 9, settings: [
            ...
            { type: Ui.ComponentType.Slider, id: 'XSOverlayTweak.WebViewHaptic', name: 'WebView', description: 'Plays a haptic feedback when Pointer is hovering a WebView element.', default: 30, options: [0, 100, 5], unit: '%' },
        ]
    },
    {
        name: 'Optimization', priority: 10, settings: [
            { type: Ui.ComponentType.Dropdown, id: 'XSOverlayTweak.EfficiencyMode', name: 'Efficiency Mode', description: 'Enables Windows Efficiency Mode for XSOverlay to reduce CPU usage when not interacting with any Overlay.<br><br><b>- Pinned Visible: does not trigger when Pinned Overlay is still visible in the play space.</b>', default: 'Enable + Pinned Visible', options: ['Disable', 'Enable', 'Enable + Pinned Visible'] },
    ...
    },
    {
        name: 'Quality of Life', priority: 12, settings: [
            ...
            { type: Ui.ComponentType.Dropdown, id: 'XSOverlayTweak.NotificationLeashedTracker', name: 'Notification Leashed Tracker', description: 'Notification tracking using leash-like behavior instead of smooth.', default: 'Enable', options: ['Disable', 'Enable', 'Enable + Fixed Height'] },
