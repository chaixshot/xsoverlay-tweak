...
const SECTIONS = [
    ...
    },
    {
        name: 'Pointer', priority: 3, settings: [
            ...
            { type: Ui.ComponentType.Dropdown, id: 'XSOverlayTweak.PullTriggerPointerLock', name: 'Pull Trigger Pointer Lock/Smooth', description: 'Locks/Smooths the Pointer while the Trigger is held for easier double clicking.<br>- Uses the Trigger Value from SteamVR Input and Double Click Delay from XSOverlay settings.', default: "Smooth for Capture Overlay", options: ['Disable', 'Lock for Capture Overlay', 'Lock for Capture + WebView Overlay', 'Smooth for Capture Overlay', 'Smooth for Capture + WebView Overlay'] },
    ...
    },
    {
        name: 'Fix', priority: 11, settings: [
            ...
            { type: Ui.ComponentType.Toggle, id: 'XSOverlayTweak.HandleScrollingFix', name: 'Handle Scrolling', description: 'Support horizontal scrolling and control scroll speed with the thumbstick axis value.', default: true },
